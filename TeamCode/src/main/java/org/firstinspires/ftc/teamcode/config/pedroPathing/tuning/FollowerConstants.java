package org.firstinspires.ftc.teamcode.config.pedroPathing.tuning;
...
public class FollowerConstants {
    ...
    public static String leftRearMotorName = "rearLeft";
    public static String rightFrontMotorName = "frontRight";
    public static String rightRearMotorName = "rearRight";
