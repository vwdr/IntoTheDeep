...
@Autonomous(name="RedObservation", group="R")
public class RedObservation extends OpMode {
    ...
    @Override
    public void init() {
        auto = new Auto(hardwareMap, telemetry, new Follower(hardwareMap), false, false);
    }
