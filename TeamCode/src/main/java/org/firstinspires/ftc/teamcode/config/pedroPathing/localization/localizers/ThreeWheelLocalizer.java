package org.firstinspires.ftc.teamcode.config.pedroPathing.localization.localizers;

import com.acmerobotics.dashboard.config.Config;
import com.qualcomm.robotcore.hardware.DcMotorEx;
import com.qualcomm.robotcore.hardware.HardwareMap;

import org.firstinspires.ftc.teamcode.config.pedroPathing.localization.Encoder;
import org.firstinspires.ftc.teamcode.config.pedroPathing.localization.Localizer;
import org.firstinspires.ftc.teamcode.config.pedroPathing.localization.Matrix;
...
import org.firstinspires.ftc.teamcode.config.pedroPathing.util.NanoTimer;
...
public class ThreeWheelLocalizer extends Localizer {
    ...
    public ThreeWheelLocalizer(HardwareMap map, Pose setStartPose) {
        ...
        leftEncoderPose = new Pose(-5.375,-3.375 , 0);
        rightEncoderPose = new Pose(5.375, -3.375, 0);
        strafeEncoderPose = new Pose(-3.7, 5.2, Math.toRadians(90));
        ...
        strafeEncoder = new Encoder(hardwareMap.get(DcMotorEx.class, "rearRight"));
